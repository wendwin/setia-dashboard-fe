<template>
    <div>
        ...
        <div
            ...
            <iframe src="/assets/visualization/lda_visualization_positif_d.html" class="w-full h-screen"
        ...
        <div
            ...
            <iframe src="/assets/visualization/lda_visualization_negatif_d.html" class="w-full h-screen"
                style="border: none;"></iframe>
        </div>
    </div>
</template>
