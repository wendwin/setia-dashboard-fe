<template>
    ...
    <fwb-toast v-if="isShowToast" class="fixed top-4 lg:top-16 right-4 z-50 font-bold text-lg bg-green-500 text-white">
        <div class="flex items-center gap-3">
            <font-awesome-icon :icon="['fa', 'circle-check']" class="text-xl"/>
